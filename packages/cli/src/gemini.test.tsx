...
describe('gemini.tsx main function', () => {
  ...
  let originalEnvQwenSandbox: string | undefined;
  ...
  beforeEach(() => {
    ...
    originalEnvQwenSandbox = process.env.QWEN_SANDBOX;
  ...
  afterEach(() => {
    ...
    if (originalEnvQwenSandbox !== undefined) {
      process.env.QWEN_SANDBOX = originalEnvQwenSandbox;
    } else {
      delete process.env.QWEN_SANDBOX;
    }
