...
import { useQwenStream, mergePartListUnions } from './useQwenStream.js';
...
import { Config, EditorType, AuthType } from '@qwen/qwen-cli-core';
...
vi.mock('@qwen/qwen-cli-core', async (importOriginal) => {
...
// --- Tests for useQwenStream Hook ---
describe('useQwenStream', () => {
  ...
  beforeEach(() => {
    ...
    // Define the mock for getQwenClient
    ...
    mockConfig = {
      ...
      getQwenClient: mockGetGeminiClient,
  ...
  const renderTestHook = (
    ...
    const client = geminiClient || mockConfig.getQwenClient();
  ...
  describe('Error Handling', () => {
    it('should call parseAndFormatApiError with the correct authType on stream initialization failure', async () => {
      ...
      const mockAuthType = AuthType.USE_QWEN_DASHSCOPE;
